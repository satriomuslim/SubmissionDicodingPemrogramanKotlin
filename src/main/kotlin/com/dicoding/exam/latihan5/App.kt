 ...
 *
 */
suspend fun sum(valueA: Int, valueB: Int): Int = runBlocking {
    launch {
        delay(3000)
    }
    return@runBlocking valueA + valueB  //return 0
}
 ...
 *
 */
suspend fun multiple(valueA: Int, valueB: Int): Int = runBlocking {
    launch {
        delay(2000)
    }
    return@runBlocking valueA * valueB
}
